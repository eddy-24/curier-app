...
-- Creat: 2026-01-12 (VERSIUNE CORECTATA)
-- =====================================================
...
-- ID 6-8: Curieri originali
-- ID 9: Operator original
-- ID 10: Admin
-- ID 11-20: Clienti noi
-- ID 21-24: Curieri noi
-- ID 25-26: Operatori noi
...
-- ===== ADRESE (40 total) =====
-- ID 1-15: Adrese expeditori (clienti)
-- ID 16-40: Adrese destinatari

-- Adrese clienti (expeditori) - ID 1-15
...
-- Adrese destinatari (fara utilizator) - ID 16-40
...
-- Comenzi vechi finalizate (decembrie 2025) - ID 1-10
...
-- Comenzi din saptamana trecuta (finalizate) - ID 11-13
...
-- Comenzi noi (neasignate) - ID 19-25
...
-- ===== COLETE (28 total) =====
-- Folosim adrese: expeditori 1-15, destinatari 16-40
...
-- Colete livrate (comenzi vechi) - ID 1-10
(1, 'AWB2025120501', 2.5, 0.015, 'Standard', 150.00, true, 'livrat', 1, 16, 6, '2025-12-07 14:30:00'),
(2, 'AWB2025120801', 1.8, 0.008, 'Express', 280.00, NULL, 'livrat', 2, 17, 7, '2025-12-09 11:00:00'),
(3, 'AWB2025121001', 3.2, 0.025, 'Standard', 95.00, true, 'livrat', 3, 18, 8, '2025-12-12 16:45:00'),
(4, 'AWB2025121201', 4.5, 0.030, 'Rapid', 420.00, NULL, 'livrat', 4, 19, 6, '2025-12-14 10:15:00'),
(5, 'AWB2025121501', 2.1, 0.012, 'Standard', 175.00, true, 'livrat', 5, 20, 7, '2025-12-17 15:30:00'),
(6, 'AWB2025121801', 5.8, 0.040, 'Express', 550.00, NULL, 'livrat', 6, 21, 8, '2025-12-20 09:00:00'),
(7, 'AWB2025122001', 1.5, 0.008, 'Document', 85.00, true, 'livrat', 7, 22, 21, '2025-12-22 14:00:00'),
(8, 'AWB2025122201', 3.8, 0.025, 'Standard', 320.00, NULL, 'livrat', 8, 23, 22, '2025-12-24 11:30:00'),
(9, 'AWB2025122701', 2.3, 0.014, 'Rapid', 195.00, true, 'livrat', 9, 24, 23, '2025-12-29 16:00:00'),
(10, 'AWB2025123001', 4.1, 0.028, 'Express', 380.00, NULL, 'livrat', 10, 25, 24, '2026-01-02 10:45:00'),

-- Colete livrate (saptamana trecuta) - ID 11-13
(11, 'AWB2026010501', 1.9, 0.011, 'Standard', 165.00, true, 'livrat', 1, 26, 6, '2026-01-07 15:20:00'),
(12, 'AWB2026010601', 3.4, 0.022, 'Express', 290.00, NULL, 'livrat', 2, 27, 7, '2026-01-08 12:00:00'),
(13, 'AWB2026010701', 2.7, 0.016, 'Rapid', 225.00, true, 'livrat', 6, 28, 8, '2026-01-09 14:30:00'),

-- Colete in curs de livrare - ID 14-18
(14, 'AWB2026010801', 2.5, 0.015, 'Standard', 150.00, false, 'in_livrare', 1, 29, 6, NULL),
(15, 'AWB2026010901', 1.8, 0.008, 'Rapid', 89.50, false, 'in_tranzit', 2, 30, 7, NULL),
(16, 'AWB2026011001', 3.2, 0.025, 'Standard', NULL, NULL, 'ridicat', 3, 18, 8, NULL),
(17, 'AWB2026011002', 1.2, 0.005, 'Express', 245.00, false, 'preluat_curier', 7, 31, 21, NULL),
(18, 'AWB2026011101', 4.1, 0.035, 'Standard', 320.00, false, 'in_tranzit', 8, 32, 22, NULL),

-- Colete in asteptare (comenzi noi) - ID 19-25
(19, 'AWB2026011102', 2.9, 0.018, 'Standard', 245.00, false, 'in_asteptare', 9, 33, NULL, NULL),
(20, 'AWB2026011103', 1.4, 0.007, 'Document', 75.00, NULL, 'in_asteptare', 10, 34, NULL, NULL),
(21, 'AWB2026011201', 3.6, 0.024, 'Express', 315.00, false, 'in_asteptare', 4, 35, NULL, NULL),
(22, 'AWB2026011202', 4.3, 0.029, 'Rapid', 395.00, false, 'in_asteptare', 5, 36, NULL, NULL),
(23, 'AWB2026011203', 2.2, 0.013, 'Standard', 185.00, NULL, 'in_asteptare', 6, 37, NULL, NULL),
(24, 'AWB2026011204', 1.8, 0.010, 'Express', 155.00, false, 'in_asteptare', 7, 38, NULL, NULL),
(25, 'AWB2026011205', 3.1, 0.020, 'Standard', 265.00, false, 'in_asteptare', 8, 39, NULL, NULL);

-- Colete suplimentare pentru comenzi cu multiple colete - ID 26-28
INSERT INTO colet (id_comanda, cod_awb, greutate_kg, volum_m3, tip_serviciu, pret_declarat, ramburs_incasat, status_colet, id_adresa_expeditor, id_adresa_destinatar, id_curier, data_livrare) VALUES
(14, 'AWB2026010802', 1.2, 0.006, 'Document', 65.00, false, 'in_livrare', 1, 16, 6, NULL),
(2, 'AWB2025120802', 0.8, 0.003, 'Document', 25.00, NULL, 'livrat', 2, 21, 7, '2025-12-09 11:30:00'),
(16, 'AWB2026011003', 2.4, 0.015, 'Standard', 205.00, NULL, 'ridicat', 3, 19, 8, NULL);
...
(1, 'in_livrare', 'Bucuresti - Calea Victoriei', 'Curier in zona de livrare', '2025-12-07 13:30:00', 6),
(1, 'livrat', 'Calea Victoriei 126', 'Colet livrat cu succes - Ramburs incasat', '2025-12-07 14:30:00', 6),

-- AWB2025120801 (colet ID 2)
...
(2, 'in_livrare', 'Constanta - Strada Mihai Viteazu', 'Curier in zona de livrare', '2025-12-09 10:00:00', 7),
(2, 'livrat', 'Strada Mihai Viteazu 33', 'Colet livrat cu succes', '2025-12-09 11:00:00', 7),

-- AWB2025121001 (colet ID 3)
(3, 'inregistrat', 'Depozit Timisoara', 'Colet inregistrat - Ramburs 95 RON', '2025-12-10 10:00:00', 9),
(3, 'preluat_curier', 'Depozit Timisoara', 'Preluat de curier Radu Dobre', '2025-12-10 10:30:00', 8),
(3, 'in_tranzit', 'Autostrada A1', 'Transport catre Iasi', '2025-12-11 07:00:00', 8),
(3, 'in_livrare', 'Iasi - Bulevardul Carol I', 'Curier in zona de livrare', '2025-12-12 15:00:00', 8),
(3, 'livrat', 'Bulevardul Carol I 19', 'Colet livrat - Ramburs incasat', '2025-12-12 16:45:00', 8);

-- Evenimente pentru colete in curs
INSERT INTO tracking_event (id_colet, status, locatie, descriere, data_event, id_utilizator) VALUES
-- AWB2026010801 (colet ID 14) - In livrare
(14, 'inregistrat', 'Depozit Bucuresti', 'Colet preluat de la client si inregistrat', '2026-01-08 11:00:00', 9),
(14, 'preluat_curier', 'Depozit Bucuresti', 'Asignat curierului Dan Marinescu', '2026-01-08 11:30:00', 6),
(14, 'in_tranzit', 'Soseaua Nordului', 'Colet in transport catre destinatie', '2026-01-08 12:00:00', 6),
(14, 'in_livrare', 'Brasov - Bulevardul Eroilor', 'Curier in zona de livrare', '2026-01-12 09:30:00', 6),

-- AWB2026010901 (colet ID 15) - In tranzit
...
-- AWB2026011001 (colet ID 16) - Ridicat
...
-- AWB2026011002 (colet ID 17) - Preluat curier
...
-- AWB2026011101 (colet ID 18) - In tranzit
...
-- Evenimente pentru colete suplimentare
INSERT INTO tracking_event (id_colet, status, locatie, descriere, data_event, id_utilizator) VALUES
(26, 'inregistrat', 'Depozit Bucuresti', 'Document inregistrat', '2026-01-08 11:00:00', 9),
(26, 'preluat_curier', 'Depozit Bucuresti', 'Asignat curierului Dan Marinescu', '2026-01-08 11:30:00', 6),
(26, 'in_livrare', 'Bucuresti - Calea Victoriei', 'Curier in zona de livrare', '2026-01-12 09:30:00', 6),

(27, 'inregistrat', 'Depozit Cluj-Napoca', 'Document inregistrat', '2025-12-08 15:00:00', 9),
(27, 'preluat_curier', 'Depozit Cluj-Napoca', 'Preluat de curier Ana Stoica', '2025-12-08 15:30:00', 7),
(27, 'livrat', 'Strada Brailei 156', 'Document livrat cu succes', '2025-12-09 11:30:00', 7),

(28, 'inregistrat', 'Depozit Timisoara', 'Colet inregistrat', '2026-01-10 10:15:00', 9),
(28, 'preluat_curier', 'Depozit Timisoara', 'Asignat curierului Radu Dobre', '2026-01-10 10:45:00', 8),
(28, 'ridicat', 'Bulevardul Revolutiei 42', 'Colet ridicat de la expeditor', '2026-01-10 11:30:00', 8);
...
-- ===== RAPORT FINAL =====
SELECT '=== DATE ADAUGATE CU SUCCES ===' as info;
SELECT 'Utilizatori: ' || COUNT(*) as info FROM utilizator;
SELECT '  - Admin: ' || COUNT(*) as info FROM utilizator WHERE rol = 'admin';
SELECT '  - Operatori: ' || COUNT(*) as info FROM utilizator WHERE rol = 'operator';
SELECT '  - Curieri: ' || COUNT(*) as info FROM utilizator WHERE rol = 'curier';
SELECT '  - Clienti: ' || COUNT(*) as info FROM utilizator WHERE rol = 'client';
SELECT 'Adrese: ' || COUNT(*) as info FROM adresa;
SELECT 'Comenzi: ' || COUNT(*) as info FROM comanda;
SELECT 'Colete: ' || COUNT(*) as info FROM colet;
SELECT 'Evenimente tracking: ' || COUNT(*) as info FROM tracking_event;
SELECT 'Facturi: ' || COUNT(*) as info FROM factura;
SELECT 'Rute curieri: ' || COUNT(*) as info FROM ruta_curier;

SELECT '=== PAROLE ===' as info;
SELECT 'admin: admin123' as info;
SELECT 'operatori: operator123' as info;
SELECT 'curieri: curier123' as info;
SELECT 'clienti: client123' as info;
